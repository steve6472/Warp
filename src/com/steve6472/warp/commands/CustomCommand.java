...
import com.steve6472.warp.commands.exception.NotPlayerException;
...
public abstract class CustomCommand
{
	...
	protected Player getPlayer(CommandContext<CommandListenerWrapper> context) throws com.steve6472.warp.commands.CommandException
	{
		if (!isPlayer(context))
	...
	protected void sendInfoMessage(CommandContext<CommandListenerWrapper> context, Object... text) throws CommandSyntaxException
	{
		...
		try
		{
			warpName = getString(context, "com/steve6472/warp");
